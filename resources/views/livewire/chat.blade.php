                    ...
                    <div class="position-absolute bottom-0 bg-white px-2" style="height: 45px; width: 100%;">
                        <div class="pt-1">
                            <div class="d-flex flex-row justify-content-around">
                                ...
                                <textarea name="message" wire:model="text" id="message" rows="1" class="form-control rounded-pill me-2" style="width: 70%; resize: none; height: fit-content;" placeholder="Type your message here..." required></textarea>
